    ...
    <div class="row">
        <div class="col-xs-12">
            <ul class="nav nav-pills nav-justified">
                ...
                <div class="col-xs-11">
                    <li class="dropdown"><h3 style="margin-top:-5px;"><spam class="glyphicon glyphicon-lock"> </spam>  BIENVENIDO EN CROVAN KEGS</h3></a></li>                
                </div>                         
            </ul>
        </div>
    </div>
            ...
            <form>
               <?php
                ...
                <div class="scale__container--js">
                    <h4 class="scale--js tituloA">INGRESA CON TU USUARIO A CROVAN KEGS PARA CONFIRMAR LA COMPRA</h4>
                </div>
