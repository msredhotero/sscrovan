...
case 'traerProductosWeb':
	traerProductosWeb($serviciosReferencias);
	break;
case 'traerProductosWebOrden':
	traerProductosWebOrden($serviciosReferencias);
	break;
case 'traerProductosWebBuscar':
	traerProductosWebBuscar($serviciosReferencias);
	break;
...
case 'insertarSubCategorias': 
insertarSubCategorias($serviciosReferencias); 
break; 
case 'modificarSubCategorias': 
modificarSubCategorias($serviciosReferencias); 
break; 
case 'eliminarSubCategorias': 
eliminarSubCategorias($serviciosReferencias); 
break; 

case 'insertarSubsubCategorias': 
insertarSubsubCategorias($serviciosReferencias); 
break; 
case 'modificarSubsubCategorias': 
modificarSubsubCategorias($serviciosReferencias); 
break; 
case 'eliminarSubsubCategorias': 
eliminarSubsubCategorias($serviciosReferencias); 
break; 
...
/***************** 			WEB 					****************************/
case 'traerProductosPorCategoriaWeb':
	traerProductosPorCategoriaWeb($serviciosReferencias);
	break;
case 'traerProductosPorCategoriaEspecificacionWeb':
	traerProductosPorCategoriaEspecificacionWeb($serviciosReferencias);
	break;
...
function traerProductosPorCategoriaWeb($serviciosReferencias) {
	$res = $serviciosReferencias->traerProductosPorCategoriaWeb($_POST['idCategoria']);
...
function traerProductosPorCategoriaEspecificacionWeb($serviciosReferencias) {
	$res = $serviciosReferencias->traerProductosPorCategoriaEspecificaionWeb($_POST['idcategoria'], $_POST['especificaciones']);
...
function traerProductosWeb($serviciosReferencias) {
	...
	while ($row =	mysqli_fetch_array($res)) {
		...
		$cad .= ' <tr>
				 <th scope="row">'.$i.'</th>
				  <td> <img class="img-thumbnail" width=" 60px" src="sistema/archivos/galeria/'.$row['idproducto'].'/'.$row['imagenproducto'].'" alt=""> '.$row['nombre'].'</td>
				   <td class="text-left"><small>'.$row['descripcion'].'.</small></td>
...
function traerProductosWebOrden($serviciosReferencias) {
	$Orden	=	$_POST['orden'];
	$res	=	$serviciosReferencias->traerProductosOrden($Orden);
...
function traerProductosWebBuscar($serviciosReferencias) {
	$Busqueda	=	$_POST['busqueda'];
	$res	=	$serviciosReferencias->traerProductosWebBuscar($Busqueda);
...
$marca = $_POST['marca'];
	...
	$res = $serviciosReferencias->insertarProductos($codigo,$codigobarra,$nombre,$descripcion,$stock,$stockmin,$preciocosto,$precioventa,$preciodescuento,$utilidad,$imagen,$refcategorias,$tipoimagen,$unidades,$refproveedores,$capacidad,$marca); 
...
$activo = 0;
	...
	$res = $serviciosReferencias->modificarProductos($id,$codigo,$codigobarra,$nombre,$descripcion,$stock,$stockmin,$preciocosto,$precioventa,$preciodescuento,$utilidad,$imagen,$refcategorias,$tipoimagen,$unidades,$activo,$refproveedores,$capacidad,$marca); 
...
function insertarSubCategorias($serviciosReferencias) {
$descripcion = $_POST['descripcion'];
$refcategorias = $_POST['refcategorias'];
if (isset($_POST['esegreso'])) {
$esegreso = 1;
...
$res = $serviciosReferencias->insertarSubCategorias($descripcion,$esegreso,$activo,$refcategorias);
if ((integer)$res > 0) {
echo '';
} else {
echo 'Hubo un error al insertar datos';
...
function modificarSubCategorias($serviciosReferencias) {
$id = $_POST['id'];
$descripcion = $_POST['descripcion'];
$refcategorias = $_POST['refcategorias'];
if (isset($_POST['esegreso'])) {
...
$res = $serviciosReferencias->modificarSubCategorias($id,$descripcion,$esegreso,$activo,$refcategorias);
if ($res == true) {
echo '';
} else {
echo 'Hubo un error al modificar datos';
...
function eliminarSubCategorias($serviciosReferencias) { 
	$id = $_POST['id']; 
	
	//$resR = $serviciosReferencias->traerProductosPorCategoria($id);
	
	$res = $serviciosReferencias->eliminarSubCategorias($id); 
...
function insertarSubsubCategorias($serviciosReferencias) {
$descripcion = $_POST['descripcion'];
$refsubcategorias = $_POST['refsubcategorias'];
if (isset($_POST['esegreso'])) {
$esegreso = 1;
} else {
$esegreso = 0;
...
$res = $serviciosReferencias->insertarSubsubCategorias($descripcion,$esegreso,$activo,$refsubcategorias);
if ((integer)$res > 0) {
echo '';
} else {
echo 'Hubo un error al insertar datos';
...
function modificarSubsubCategorias($serviciosReferencias) {
$id = $_POST['id'];
$descripcion = $_POST['descripcion'];
$refsubcategorias = $_POST['refsubcategorias'];
if (isset($_POST['esegreso'])) {
...
$res = $serviciosReferencias->modificarSubsubCategorias($id,$descripcion,$esegreso,$activo,$refsubcategorias);
if ($res == true) {
echo '';
} else {
echo 'Hubo un error al modificar datos';
...
function eliminarSubsubCategorias($serviciosReferencias) { 
	$id = $_POST['id']; 
	
	//$resR = $serviciosReferencias->traerProductosPorCategoria($id);
	
	$res = $serviciosReferencias->eliminarSubsubCategorias($id); 
